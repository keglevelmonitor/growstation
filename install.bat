...
:: install.bat - GrowStation installation (run from project directory)
...
SET "ICON_PATH=%PROJECT_DIR%\src\assets\evolution.png"
...
SET "ICON_ICO=%PROJECT_DIR%\src\assets\evolution.ico"
...
echo Shortcut created on Desktop: GrowStation.lnk
...
echo ==========================================
echo.
echo Run GrowStation from the Desktop shortcut or:
